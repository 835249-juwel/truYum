...
insert into truyum.menu_item(me_name,me_price,me_active,me_date_of_launch,me_category,me_free_delivery) values('Chocolate',32.00,'Yes','2022-11-02','Desserts','Yes');
...
insert into truyum.user(us_name) values('Dilip');
insert into truyum.user(us_name) values('Vishal');
...
-- 5.     View Cart (TYUC005)
-- a. Retriveing all the carts from the particular user id
